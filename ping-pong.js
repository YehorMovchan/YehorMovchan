...
function check(x){
     if(startPosBall[0]+x<=15) {
          ...
          clearInterval(moveBallInt); finalPos='l'; moveBall()
               ...
               if(score[0]==1) {document.getElementById('win').innerHTML=win1;  view()}
               else if(score[1]==1) {document.getElementById('win').innerHTML=win2; document.getElementById('winok').innerHTML=winok1;  view()}
               else {startMoveBall()}}
     }
               ...
               clearInterval(moveBallInt); finalPos='r'; moveBall()
                    ...
                    if(score[0]==1) {document.getElementById('win').innerHTML=win1;  view()}
                    else if(score[1]==1) {document.getElementById('win').innerHTML=win2; document.getElementById('winok').innerHTML=winok2;  view()}
                    else {startMoveBall()}}}
